...
![create_ressource_group](../ressources/pictures/ressource_creation/create_ressource_group.png)
...
![create_function_app_inside_ressource_group](../ressources/pictures/ressource_creation/create_function_app_inside_ressource_group.png)

Be sure to check the ressource group nonetheless.
It has to be the one we previously created.

![select_correct_ressource_group](../ressources/pictures/ressource_creation/select_correct_ressource_group.png)

You also have to create a new App Service Plan, you can do this directly from here.

![create_new_app_service_plan](../ressources/pictures/ressource_creation/create_new_app_service_plan.png)
